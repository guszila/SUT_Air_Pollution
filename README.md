...
> **ทำให้มองเห็นอากาศที่เราหายใจ**

มลพิษทางอากาศคือภัยคุกคามที่มองไม่เห็น โครงงานนี้ช่วยลดช่องว่างระหว่างข้อมูลสภาพแวดล้อมที่ซับซ้อนกับการตัดสินใจในชีวิตประจำวัน โดยระบบจะทำการแปลงข้อมูลตัวชี้วัดคุณภาพอากาศดิบที่เก็บจากเซนเซอร์ IoT ให้กลายเป็นแผนที่เชิงโต้ตอบแบบเรียลไทม์ที่ใช้งานง่ายและเข้าใจได้ทันที
